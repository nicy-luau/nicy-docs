...
const siteData = deserializeFunctions(JSON.parse('{"lang":"pt-BR","dir":"ltr","title":"Nicy","description":"Modern Luau runtime and tooling docs","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/logo.svg","nav":[{"text":"Início","link":"/"},{"text":"Instalação","link":"/install"},{"text":"GitHub","link":"https://github.com/nicy-luau"}],"sidebar":[{"text":"Guia","items":[{"text":"Introdução","link":"/"},{"text":"Instalação","link":"/install"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/nicy-luau"}],"footer":{"message":"Nicy Luau","copyright":"Copyright © 2026"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
